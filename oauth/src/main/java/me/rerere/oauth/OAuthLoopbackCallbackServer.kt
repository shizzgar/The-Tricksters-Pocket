...
class OAuthLoopbackCallbackServer(
    ...
    private fun successHtml() = callbackPage(
        ...
        hint = localizedString(
            ...
            "You can close this tab and return to The Trickster's Pocket.",
        ),
    )
    ...
    private fun errorHtml() = callbackPage(
        ...
        hint = localizedString(
            ...
            "Close this tab and try again from The Trickster's Pocket.",
        ),
    )
    ...
    private fun invalidCallbackHtml() = callbackPage(
        ...
        hint = localizedString(
            ...
            "Return to The Trickster's Pocket and start the authorization again.",
        ),
    )
    ...
    private fun callbackAlreadyHandledHtml() = callbackPage(
        ...
        hint = localizedString(
            ...
            "You can safely close this tab and return to The Trickster's Pocket.",
        ),
    )
    ...
    private fun callbackPage(
        ...
        return """
            ...
            <head>
              ...
              <title>$safeTitle · The Trickster's Pocket</title>
              <style>
                :root {
            ...
            <body class="$tone">
              <main role="status" aria-live="polite">
                <p class="brand">The Trickster's Pocket</p>
                <div class="status">
