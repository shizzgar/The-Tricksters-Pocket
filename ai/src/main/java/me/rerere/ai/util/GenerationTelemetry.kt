...
internal class GenerationTelemetry(private val observer: me.rerere.ai.provider.GenerationRequestObserver? = null) : EventListener() {
    ...
    override fun responseHeadersEnd(call: Call, response: Response) {
        ...
        observer?.headers(response.code, backend)
