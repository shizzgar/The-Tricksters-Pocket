...
Для версии [`92451a6`](https://github.com/shizzgar/rikkahub-agent/commit/92451a68719be2074ce35f1449372d62a5918ebd) [успешный CI](https://github.com/shizzgar/rikkahub-agent/actions/runs/36023590276) подтвердил **808 JVM-тестов, 46 Python-тестов и 32 Android-теста**. Проверены миграция промптов с сохранением ручных правок, английские инструкции и манифесты обоих Bro, helpers NetBro, миграция восстановленной БД, прерывание QuickJS, ReBro Blue, уточнения во время работы и Stop, полный экспорт трассы, доступность tools, UI на эмуляторе в телефонном и широком форматах, а также подпись ARM64 APK. Это результат конкретной ревизии; текущие прогоны видны в [Actions](https://github.com/shizzgar/rikkahub-agent/actions/workflows/compaction-debug.yml).
