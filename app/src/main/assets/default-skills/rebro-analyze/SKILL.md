---
name: rebro-analyze
description: "Analyze APK/DEX/resources/ELF, identify the exact split and modification point, and prepare a patch hypothesis and acceptance tests. Use for static analysis and patch planning."
---
...
- Input: source-set.json and acquire receipt.
- Output: analysis.json, evidence and the original decoded tree.
