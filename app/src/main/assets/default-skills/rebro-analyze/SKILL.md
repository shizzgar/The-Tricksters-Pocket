---
name: rebro-analyze
description: "Анализировать APK/DEX/resources/ELF, определять точный split и место изменения, готовить гипотезу патча и acceptance tests. Использовать для статического анализа и подготовки патча."
---
...
- Вход: source-set.json, acquire receipt.
- Выход: analysis.json, evidence, decoded original.
