---
name: rebro-workflow
description: "Manage a multistage Android RE case: select a route, load specialist skills, verify receipts and recover from interruption. Use for the patch-build-sign-install-verify pipeline."
---
...
- Input: Selected case, objective and scope.
- Output: Explicit route and last evidenced result.
- The orchestrator has no separate workflow stage; it coordinates the listed stages.
...
- [Detailed operating reference](references/operating-rules.md) — read only the relevant section; inventory and past results are dated evidence.
