---
name: rebro-acquire
description: "Получать исходный APK и полный installed split set для конкретного package/Android user, фиксировать hashes, metadata и сертификаты. Использовать перед анализом установленного приложения."
---
...
- Вход: Package/user, environment receipt.
- Выход: source-set.json и копии исходников.
