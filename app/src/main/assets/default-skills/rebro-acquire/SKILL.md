---
name: rebro-acquire
description: "Acquire source APKs and a complete installed split set for a specific package/Android user; record hashes, metadata and certificates. Use before analyzing an installed application."
---
...
- Input: Package/user and environment receipt.
- Output: source-set.json and source copies.
