---
name: rebro-patch
description: "Prepare and apply an exact reproducible patch to decoded smali/resources/manifest/native assets. Use for APK code or resource changes; preserve originals and preimage hashes."
---
...
- Input: Analysis, decoded tree and exact patch plan.
- Output: patch-report.json and a new patched tree.
