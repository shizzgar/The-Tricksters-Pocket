---
name: rebro-patch
description: "Готовить и применять точный воспроизводимый патч к decoded smali/resources/manifest/native assets. Использовать когда нужно изменить APK-код или ресурсы; сохранять исходники и preimage hashes."
---
...
- Вход: Analysis, decoded tree, exact patch plan.
- Выход: patch-report.json и новое patched tree.
