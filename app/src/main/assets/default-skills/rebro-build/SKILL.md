---
name: rebro-build
description: "Собирать изменённый APK через Apktool/native Termux AAPT2 и собирать полный candidate split set. Использовать после патча и для диагностики rebuild; проверять identity и полноту набора."
---
...
- Вход: Patch receipt, tree, source-set, framework/toolchain.
- Выход: candidate-set.json и новые APK.
