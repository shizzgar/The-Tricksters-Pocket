---
name: rebro-build
description: "Rebuild a patched APK with resource-aware Apktool/AAPT2 execution, preserve split topology and create a verified candidate set. Use after patching, before signing."
---
...
- Input: Patch receipt, patched tree and original APK set.
- Output: Unsigned build output, logs and candidate-set.json.
