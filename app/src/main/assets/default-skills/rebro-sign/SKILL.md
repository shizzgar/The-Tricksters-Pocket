---
name: rebro-sign
description: "Выравнивать, подписывать и проверять APK или полный split set одним ожидаемым лабораторным сертификатом. Использовать для подписи готового APK или результата rebuild; поддерживать sign-only intake."
---
...
- Вход: Candidate set, keystore/alias/password files, expected certificate.
- Выход: signed-set.json и verification logs.
