---
name: rebro-sign
description: "Align, sign and verify an APK or complete split set with one expected lab certificate. Use for a supplied APK or rebuild output; support sign-only intake."
---
...
- Input: Candidate set, keystore/alias/password files and expected certificate.
- Output: signed-set.json and verification logs.
