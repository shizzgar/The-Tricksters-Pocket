---
name: rebro-verify
description: "Verify an APK patch after installation using baseline, target and regression checks with evidence. Use to establish behavior rather than equating it with successful signing."
---
...
- Input: Install receipt, acceptance tests and test target.
- Output: verification.json and actual evidence files.
