                ...
                CardGroup(
                    ...
                    item(
                        ...
                        trailingContent = {
                            IconButton(
                                onClick = {
                                    context.openUrl("https://github.com/shizzgar/The-Tricksters-Pocket")
                                }
                            ) {
                                Icon(
                                    imageVector = HugeIcons.Github,
                                    contentDescription = stringResource(R.string.about_page_github),
                    ...
                    item(
                        onClick = {
                            val docUrl = "https://github.com/shizzgar/The-Tricksters-Pocket/blob/master/docs/getting-started.md"
