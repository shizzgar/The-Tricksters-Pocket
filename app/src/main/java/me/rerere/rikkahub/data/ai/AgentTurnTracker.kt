...
/**
 * Per-turn record of "did the agent take the user out of The Trickster's Pocket?" — used by the
 * post-turn auto-return logic to decide whether to bring The Trickster's Pocket back to the
